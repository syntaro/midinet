...
public class MXMidiStatic {
    static String TAG = "MXMidiStatic";

    /*
    public static void main(String[] args) {
        File dir = new File("C:/java/release/2022-02-work/src");
        File file = new File(dir, "MXMidi.java");
        InputStream in = null;
        ...
        try {
            ...
            sort.sort(new Comparator<String>() {
                ...
                public int compare(String o1, String o2) {
                    ...
                    int i1 = 0, i2 = 0;
                    try {
                        i1 = MXUtil.numberFromText(o1);
                    }
                    catch(NumberFormatException ex) {

                    }
                    try {
                        i2 = MXUtil.numberFromText(o2);
                    }
                    catch(NumberFormatException ex) {
    ...
    public static final int COMMAND2_CH_PROGRAMCHANGE_BANK = 0x6300; /* @PC2 pc, msb, lsb */
    ...
    public static final int DATA1_CC_SOUND_HARMONICS_CONTENT = 71;
    ...
    public static final String nameOfChannelMessage(int command) {
        switch (command) {
            ...
            case MXMidiStatic.COMMAND_CH_CHANNELPRESSURE:
                return "Press";
            case MXMidiStatic.COMMAND_CH_PITCH:
                return "PITCH";
        }
        return null;
    }
    ...
    public static final String nameOfControlChange(int data1cc) {
        ...
        switch (data1cc) {
            ...
            case MXMidiStatic.DATA1_CC_SOUND_HARMONICS_CONTENT:
    ...
    public static String nameOfSystemRealtimeMessage(int command) {
        switch (command) {
            ...
            case MXMidiStatic.COMMAND_F9:
                return "#F9";
            case MXMidiStatic.COMMAND_TRANSPOORT_START:
                return "Start";
            case MXMidiStatic.COMMAND_TRANSPORT_CONTINUE:
                return "Continue";
            case MXMidiStatic.COMMAND_TRNASPORT_STOP:
                return "Stop";
