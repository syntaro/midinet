 ...
 */
public abstract class OnMidiInputEventStreamForUSB implements OnMidiInputEventListener {
    ...
    @Override
    public void onMidiSystemExclusive(@NonNull MidiInputDevice sender, int cable, @NonNull byte[] systemExclusive) {
